...
\secondSupervisor{} %TODO

% text field
%-> replace title with your thesis title
\thesisTitle{Maschinelles Lernen zur Erkennung von Fake News: Grundlagen, Verfahren und Anwendungsbeispiele}
\thesisTitleEN{Machine Learning for Fake News Detection: Fundamentals, Methods and Application Examples}

% text field
%-> replace the key words with your own key words
\keywordsDE{Machinelles Lernen, Fake News, Text Mining, Klassifikation, NLP}
