...
\begin{figure}[htbp]
    \begin{center}
        ...
        \caption{\label{fig:bert_bilstm_architecture} Vgl. RNN (links) und LSTM (rechts) \cite{wang2021covid19fakenewsdetection}}
    \end{center}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{\label{fig:bert_bilstm_results} Vgl. RNN (links) und LSTM (rechts) \cite{wang2021covid19fakenewsdetection}}
    \end{center}
\end{figure}
