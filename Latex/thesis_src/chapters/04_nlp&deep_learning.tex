...
Bidirectional Encoder Representations from Transformers (BERT) löst dieses Problem. 
...
Dabei weist es wichtigen Wörtern und Phrasen im Text höhere Gewichtungen zu \cite{Deshai:2023aa}.
