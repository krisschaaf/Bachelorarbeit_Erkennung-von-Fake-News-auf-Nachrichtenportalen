...
(siehe Abbildung \ref{fig:BERT_visualization} und \ref{fig:multi_head_attention_visualization}).

%TODO: layering und multihead attention erklären
%TODO: (ein anderer Stelle) erklären mit welchen daten bert trainiert wurde!

Für das Erstellen der Wortvektoren nutzt BERT WordPiece Embeddings genutzt.
...
Statt WordPiece nutzt RoBERTa Byte-Pair-Encoding (BPE) zum Tokenisieren wobei ein Vokabular von 50.000 Token verwendet wird.
...
Auch die Vokabulargröße ist mit 250.000 Token deutlich größer als die 50.000 Token bei RoBERTa \cite{DBLP:journals/corr/abs-1911-02116}.
...
\subsubsection{XML-RoBERTa (German)}

XML-RoBERTa-large-finetuned-conll03-german

FacebookAI \cite{conneau2019unsupervised}

%TODO: conll2003 Datensatz https://huggingface.co/datasets/eriktks/conll2003


In \ref{tab:bert_models} angehängt, findet sich ein tabellarischer Vergleich der vier verschiedenen BERT- und RoBERTa-Modelle.
