...
\begin{itemize}
    ...
    \item \textbf{Persönliche Nähe zur Informationsquelle:} Informationen von Personen, denen man persönlich nahe steht oder vertraut, werden eher geglaubt – unabhängig vom Wahrheitsgehalt.
...
\cite{henke2024nachrichten, Lieb2023} und \cite{Osing2022} zeigen, dass die Kombination von BILD, taz und Der Spiegel eine politisch 
