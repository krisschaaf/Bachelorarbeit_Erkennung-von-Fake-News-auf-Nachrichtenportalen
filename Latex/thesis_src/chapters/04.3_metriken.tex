...
\begin{itemize}
    \item True Positive (TP) - Das Modell hat die positive Klasse richtig vorhergesagt. 
    ...
    \item False Positive (FP) - Das Modell hat die positive Klasse falsch vorhergesagt. 
        
    (Der Artikel, der kein Fake ist, wird als 'falsch' gedeutet)
    \item False Negative (FN) - Dein Modell hat die negative Klasse falsch vorhergesagt. 
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[scale=0.24]{static/confusion_matrix.png}
